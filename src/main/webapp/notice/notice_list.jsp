...
<body>
	<div class="container h-100">
        ...
        <c:if test="${startPage > 1}">
            <a class="bfarr" href="../notice/notice_list.do?page=1">
                <div class="arr left" style="left:9px;"></div>
                <div class="arr left" style="left:16px;"></div>
            </a>
            <a class="bfarr" href="../notice/notice_list.do?page=${startPage - 1 }">
        ...
        <c:forEach var="i" begin="${startPage}" end="${endPage}" step="1">
            <a class="${i == curPage ? 'active' : ''}" href="../notice/notice_list.do?page=${i }">${i}</a>
        </c:forEach>

        <!-- 다음 버튼 -->
        <c:if test="${endPage < totalPage}">
            <a class="afarr" href="../notice/notice_list.do?page=${endPage + 1 }">
                <div class="arr right"></div>
            </a>
            <a class="afarr" href="../notice/notice_list.do?page=${totalPage }">
