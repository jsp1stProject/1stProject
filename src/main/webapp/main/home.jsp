...
<body>
    ...
    <div class="container-xxl py-4">
    	<div class="container">
    		<h3 class="main-h3 wow fadeInUp" data-wow-delay="0.1s">지역별 숙소 핫딜</h3>
    		...
    		<div class="tab-content-wrap wow fadeInUp" data-wow-delay="0.1s">
    			<div class="tab-cont-item active" data-tab="1">
	    			<div class="swiper main-slide-list">
		    			<div class="swiper-wrapper">
							<c:forEach items="${hotelList1}" var="vo">
								<div class="li-item swiper-slide">
									<a href="../hotel/hotel_detail.do?content_id=${vo.cvo.content_id}">
										<div class="item-inner">
											<div class="item-img"
													<c:if test="${vo.cvo.first_image ne 'N/A'}">
														style="background-image:url(${vo.cvo.first_image})"
													</c:if>
											>
											</div>
											<div class="text-wrap">
												...
												<p class="score">
													...
													<span>${((vo.cvo.review_total+0.0)/(vo.cvo.review_count+0.0)) eq 'NaN'?'0':(vo.cvo.review_total+0.0)/(vo.cvo.review_count+0.0)}</span>
												</p>
											</div>
										</div>
									</a>
    			...
    			<div class="tab-cont-item" data-tab="2">
    				<div class="swiper main-slide-list">
						<div class="swiper-wrapper">
							<c:forEach items="${hotelList2}" var="vo">
								<div class="li-item swiper-slide">
									<a href="../hotel/hotel_detail.do?content_id=${vo.cvo.content_id}">
										<div class="item-inner">
											<div class="item-img"
    			...
    			<div class="tab-cont-item" data-tab="3">
    				<div class="swiper main-slide-list">
						<div class="swiper-wrapper">
							<c:forEach items="${hotelList3}" var="vo">
								<div class="li-item swiper-slide">
									<a href="../hotel/hotel_detail.do?content_id=${vo.cvo.content_id}">
										<div class="item-inner">
											<div class="item-img"
			...
			<div class="main-fes-wrap d-flex wow fadeInUp" data-wow-delay="0.1s">
				<c:forEach items="${fesList }" var="vo" varStatus="i">
					<div class="main-fes-item" style="background-image:url(${vo.cvo.first_image});">
						...
						<a href="../fes/fes_detail.do?content_id=${vo.content_id}" class="main-fes-title fs-2">${vo.cvo.title}</a>
					</div>
				</c:forEach>
			</div>
		</div>
